    ...
    return (
      <main className="da-legal">
        <div className="da-legal-inner">
          ...
          <p>Articles on this website are generated with Google Gemini assistance. Generated content is processed by Google servers for creation. Read Google&apos;s privacy policy at <a href="https://policies.google.com/privacy" rel="nofollow" target="_blank">policies.google.com/privacy</a> for more information about data processing.</p>
  ...
  return (
    <main className="da-legal">
      <div className="da-legal-inner">
        ...
        <p>Los artículos de esta web se generan con asistencia de Google Gemini. El contenido generado es procesado por los servidores de Google para su generación. Consulta la política de privacidad de Google en <a href="https://policies.google.com/privacy" rel="nofollow" target="_blank">policies.google.com/privacy</a> para más información sobre el tratamiento de datos.</p>
